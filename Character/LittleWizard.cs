...
public class LittleWizard : PlaceholderCharacterModel
{
	...
	public override CustomEnergyCounter? CustomEnergyCounter => new
		  CustomEnergyCounter(
			  i => "res://LittleWizard/images/ui/combat/energy_counters/LittleWizard/LittleWizard_orb_layer" + i + ".png",
	...
	public override string CustomMerchantAnimPath => "res://LittleWizard/scenes/LittleWizard/LittleWizard_merchant.tscn";
	public override string CustomRestSiteAnimPath => "res://LittleWizard/scenes/LittleWizard/LittleWizard_rest_site.tscn";
	...
	public override string CustomCharacterSelectLockedIconPath => "res://LittleWizard/images/LittleWizard/char_select_LittleWizard_locked.png";
	public override string CustomCharacterSelectIconPath => "res://LittleWizard/images/LittleWizard/char_select_LittleWizard.png";
}
